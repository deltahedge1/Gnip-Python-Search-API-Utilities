...
gnip_search.py -f"has:geo $rulez" -u ${un} -p ${paswd} -l ${url} -n10 -q json
gnip_search.py -f"has:geo $rulez" -u ${un} -p ${paswd} -l ${url} -n10 json
gnip_search.py -f"has:geo $rulez" -u ${un} -p ${paswd} -l ${url} -n10 geo
gnip_search.py -f"has:geo $rulez" -u ${un} -p ${paswd} -l ${url} -n10 wordcount
gnip_search.py -f"has:geo $rulez" -u ${un} -p ${paswd} -l ${url} -n10 timeline
gnip_search.py -f"has:geo $rulez" -u ${un} -p ${paswd} -l ${url} -n10 users
gnip_search.py -f"has:geo $rulez" -u ${un} -p ${paswd} -l ${url} -n10 -c geo
gnip_search.py -f"has:geo $rulez" -u ${un} -p ${paswd} -l ${url} -n10 -c timeline 
gnip_search.py -f"has:geo $rulez" -u ${un} -p ${paswd} -l ${url} -n10 -s"$dt2" -e"$dt1" json
